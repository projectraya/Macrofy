        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DietaryPreference = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ChefProfileId = table.Column<int>(type: "integer", nullable: false),
                    Title = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    DietaryType = table.Column<int>(type: "integer", nullable: false),
                    CaloriesPerDay = table.Column<int>(type: "integer", nullable: false),
                    ProteinPerDay = table.Column<int>(type: "integer", nullable: false),
                    CarbsPerDay = table.Column<int>(type: "integer", nullable: false),
                    FatPerDay = table.Column<int>(type: "integer", nullable: false),
                    PricePerWeek = table.Column<decimal>(type: "numeric(8,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealPlans_ChefProfiles_ChefProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealPlans_ChefProfileId",
                table: "MealPlans",
